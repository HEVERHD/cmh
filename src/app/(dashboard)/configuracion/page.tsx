        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="mt-1" style={{ color: 'var(--text-secondary)' }}>Personaliza tu experiencia y gestiona preferencias</p>
                </div>
            ...
            <div className="rounded-xl p-8 shadow-sm" style={{ backgroundColor: 'var(--card)', border: '1px solid var(--border)' }}>
                <div className="text-center py-12">
                    ...
                    <p className="max-w-sm mx-auto" style={{ color: 'var(--text-secondary)' }}>
                        Aquí podrás personalizar tu perfil, gestionar notificaciones, configurar opciones de seguridad y ajustar preferencias del sistema.
                    </p>
                </div>
            </div>
        </div>
